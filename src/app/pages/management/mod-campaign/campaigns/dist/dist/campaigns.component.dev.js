...
function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            if (!localStorage.getItem('reject') && !localStorage.getItem('approve') && !localStorage.getItem('pending')) {
        ...
        switch (status) {
          case 'approve':
            ...
            for (i = 0; i < this.campaigns.length; i++) {
              ...
              c = Date.now(); // console.log((b - c) / (1000 * 60 * 60 * 24));
            }
  ...
  __decorate([core_1.ViewChild('changeView')], CampaignsComponent.prototype, "changeView");

  CampaignsComponent = __decorate([core_1.Component({
