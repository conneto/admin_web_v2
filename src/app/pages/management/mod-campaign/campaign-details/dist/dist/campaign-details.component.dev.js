...
function () {
      ...
      return __generator(this, function (_g) {
        switch (_g.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.campaignApi.getPdf("" + ((_a = this.campaign) === null || _a === void 0 ? void 0 : _a.id))];
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , this.campaignApi.getCashFlow("" + ((_b = this.campaign) === null || _b === void 0 ? void 0 : _b.id))];
          ...
          case 3:
            ...
            return [4
            /*yield*/
            , this.campaignApi.getPdf("" + ((_c = this.campaign) === null || _c === void 0 ? void 0 : _c.id))];
      ...
      return __generator(this, function (_l) {
        switch (_l.label) {
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , this.campaignApi.getCashFlow("" + ((_a = this.campaign) === null || _a === void 0 ? void 0 : _a.id))];
          ...
          case 3:
            ...
            return [4
            /*yield*/
            , this.campaignApi.getPdf("" + ((_b = this.campaign) === null || _b === void 0 ? void 0 : _b.id))];
          ...
          case 5:
            ...
            return [4
            /*yield*/
            , this.campaignApi.getParticipations("" + ((_d = this.campaign) === null || _d === void 0 ? void 0 : _d.id))];
  ...
  CampaignDetailsComponent = __decorate([core_1.Component({
