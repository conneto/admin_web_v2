...
exports.CampaignRequestComponent = void 0;

var core_1 = require("@angular/core");

var CampaignRequestComponent =
/** @class */
function () {
  function CampaignRequestComponent(campaingApi) {
    this.campaingApi = campaingApi;
    this.campaigns = [];
  }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.campaingApi.getAll()];

          case 1:
            _a.campaigns = _b.sent(); // console.log(this.campaigns);
  ...
  CampaignRequestComponent = __decorate([core_1.Component({
...
exports.CampaignRequestComponent = CampaignRequestComponent;