...
function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!this.loginForm.valid) return [3
            /*break*/
            , 8];
            return [4
            /*yield*/
            , this.authService.login(this.isChecked, this.loginForm.value.username, this.loginForm.value.password)];
          ...
          case 1:
            ...
            /*break*/
            , 7];
            if (!(this.authService.currentUserValue.role_id === 'organization_manager')) return [3
            /*break*/
            , 3];
            return [4
            /*yield*/
          ...
          case 3:
            if (!(this.authService.currentUserValue.role_id === 'admin')) return [3
            /*break*/
            , 5];
            return [4
            /*yield*/
  ...
  LoginComponent = __decorate([core_1.Injectable({
    providedIn: 'root'
  }), core_1.Component({
    selector: 'app-login',
