...
function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!this.registerForm.valid) return [3
            /*break*/
            , 6];
            ...
            oldPhone = this.registerForm.value.number_phone; // this.registerForm.value.number_phone = "0" + "" + oldPhone;
            ...
            uploadData.append('account', JSON.stringify(this.registerForm.value)); // console.log(uploadData.get('account'));

            return [4
            /*yield*/
            , this.authService.register(uploadData)];
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , this.authService.login(false, this.registerForm.value.username, oldPass)];

          case 2:
            baseResponse = _a.sent();
            if (!((baseResponse === null || baseResponse === void 0 ? void 0 : baseResponse.status) == 0)) return [3
            /*break*/
            , 4];
            return [4
            /*yield*/
  ...
  RegisterComponent = RegisterComponent_1 = __decorate([core_1.Component({
