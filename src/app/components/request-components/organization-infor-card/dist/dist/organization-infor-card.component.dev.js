      ...
      return __generator(this, function (_a) {
        diaglogRef = this.dialog.open(dialog_confirm_component_1.DialogConfirmComponent, {
          ...
          data: {
            button: 'Đồng ý',
            close: 'Hủy',
            message: checkType == 'org' ? "Bạn có chắc chắn muốn chấp nhận tổ chức này không?" : checkType == 'cam' ? "Bạn có chắc chắn muốn chấp nhận chiến dịch này không?" : checkType == 'pro' ? "Bạn có chắc chắn muốn chấp nhận dự án này không?" : "Bạn có chắc chắn muốn chấp nhận tổ chức này không?"
          }
        });
      ...
      return __generator(this, function (_a) {
        diaglogRef = this.dialog.open(dialog_confirm_component_1.DialogConfirmComponent, {
          ...
          data: {
            ...
            close: 'Hủy',
            reason: true,
            message: checkType == 'org' ? 'Bạn có chắc chắn muốn từ chối xét duyệt tổ chức này không?' : checkType == 'cam' ? "Bạn có chắc chắn muốn  muốn từ chối xét duyệt chiến dịch này không?" : checkType == 'pro' ? "Bạn có chắc chắn muốn muốn từ chối xét duyệt dự án này không?" : 'Bạn có chắc chắn muốn từ chối xét duyệt tổ chức này không?'
          }
        });
        diaglogRef.afterClosed().subscribe(function (data) {
          return __awaiter(_this, void 0, void 0, function () {
