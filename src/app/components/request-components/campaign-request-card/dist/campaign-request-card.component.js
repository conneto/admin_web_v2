...
var CampaignRequestCardComponent = /** @class */ (function () {
    ...
    CampaignRequestCardComponent.prototype.approve = function () {
        var _a, _b, _c;
    ...
    CampaignRequestCardComponent.prototype.reject = function () {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_d) {
                switch (_d.label) {
    ...
    __decorate([
        core_1.Input()
    ], CampaignRequestCardComponent.prototype, "organization");
    __decorate([
        core_1.Input()
    ], CampaignRequestCardComponent.prototype, "project");
    __decorate([
        core_1.Input()
    ], CampaignRequestCardComponent.prototype, "campaign");
    __decorate([
        core_1.Input()
    ], CampaignRequestCardComponent.prototype, "isRequest");
    ...
    return CampaignRequestCardComponent;
}());
exports.CampaignRequestCardComponent = CampaignRequestCardComponent;
