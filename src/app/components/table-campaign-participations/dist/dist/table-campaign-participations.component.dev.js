...
var TableCampaignParticipationsComponent =
/** @class */
function () {
  ...
  TableCampaignParticipationsComponent.prototype.ngOnInit = function () {
    ...
    for (var i = 0; i < ((_a = this.volunteer) === null || _a === void 0 ? void 0 : _a.length); i++) {
      Object.assign(this.volunteer[i], {
        no: i + 1
      });
    }
  ...
  __decorate([core_1.Input()], TableCampaignParticipationsComponent.prototype, "entity");

  __decorate([core_1.Input()], TableCampaignParticipationsComponent.prototype, "volunteer");

  __decorate([core_1.Input()], TableCampaignParticipationsComponent.prototype, "type");

  __decorate([core_1.ViewChild(paginator_1.MatPaginator)], TableCampaignParticipationsComponent.prototype, "paginator");

  TableCampaignParticipationsComponent = __decorate([core_1.Component({
