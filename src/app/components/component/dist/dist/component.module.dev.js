...
var camapaign_form_component_1 = require("../create/campaign-form/campaign-form.component");
...
var componentModules = [menu_icon_component_1.MenuIconComponent, dashboard_card_component_1.DashboardCardComponent, user_card_component_1.UserCardComponent, organization_infor_card_component_1.OrganizationInforCardComponent, campaign_card_info_component_1.CampaignCardInfoComponent, campaign_request_card_component_1.CampaignRequestCardComponent, project_request_card_component_1.ProjectRequestCardComponent, approve_decline_button_component_1.ApproveDeclineButtonComponent, status_component_1.StatusComponent, organization_form_component_1.OrganizationFormComponent, dialog_confirm_component_1.DialogConfirmComponent, project_form_component_1.ProjectFormComponent, camapaign_form_component_1.CamapaignFormComponent, snack_bar_message_component_1.SnackBarMessageComponent, loading_spinner_component_1.LoadingSpinnerComponent, tabgroup_component_1.TabgroupComponent, search_bar_component_1.SearchBarComponent, project_item_component_1.ProjectItemComponent, campaign_item_component_1.CampaignItemComponent, table_rank_component_1.TableRankComponent, delete_entity_component_1.DeleteEntityComponent, chip_category_component_1.ChipCategoryComponent, skeletion_loading_component_1.SkeletionLoadingComponent, download_document_form_component_1.DownloadDocumentFormComponent, document_button_component_1.DocumentButtonComponent, select_type_campaign_component_1.SelectTypeCampaignComponent, change_to_list_component_1.ChangeToListComponent, list_view_component_1.ListViewComponent, table_campaign_participations_component_1.TableCampaignParticipationsComponent, show_document_component_1.ShowDocumentComponent, organization_details_component_1.OrganizationDetailsComponent, entity_status_component_1.EntityStatusComponent];
...
function () {
  ...
  ComponentModule = __decorate([core_1.NgModule({
    declarations: __spreadArrays(componentModules, [formatnumber_pipe_1.FormatnumberPipe]),
    imports: [router_1.RouterModule, common_1.CommonModule, angular_material_module_1.AngularMaterialModule],
