...
function () {
  ...
  UserApiService_1 = UserApiService;

  UserApiService.prototype.getStatistics = function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , this.api.get(campaign_api_service_1.Constant.CAMPAIGN + "/top_volunteers?type=participate")];
  ...
  UserApiService.prototype.getListUsers = function () {
    return __awaiter(this, void 0, void 0, function () {
      var res;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , this.api.get(UserApiService_1.ACCOUNTS)];
  ...
  var UserApiService_1;
  UserApiService.STATISTICS = 'statistics';
  UserApiService.ACCOUNTS = 'accounts';
  UserApiService = UserApiService_1 = __decorate([core_1.Injectable({
    providedIn: 'root'
  })], UserApiService);
