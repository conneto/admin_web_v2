...
var CampaignService = /** @class */ (function () {
    ...
    CampaignService.prototype.getCampaignsByObservable = function () {
        return this.apiService.getByObservable("" + constant_1.Constant.CAMPAIGNS).pipe(operators_1.map(function (data) {
    ...
    CampaignService.prototype.createById = function (data, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.apiService.post(constant_1.Constant.CAMPAIGNS + "/" + id, data)];
                    case 1:
                        res = _a.sent();
                        if (res.status != 0) {
    ...
    CampaignService.prototype.getParticipations = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.apiService.get(constant_1.Constant.CAMPAIGNS + "/" + id + "/" + constant_1.Constant.CAMPAIGN_PARTICIPATIONS)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.data || []];
                }
